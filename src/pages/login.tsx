  ...
  return (
    <div className="max-w-md mx-auto mt-12 bg-white rounded shadow p-8">
      ...
      <div className="flex gap-2 mb-6">
        ...
        <Button variant={role === "faculty" ? "default" : "outline"} onClick={() => setRole("faculty")}>Faculty</Button>
      </div>
      ...
      <div className="mt-4 flex justify-between text-sm">
        ...
        <a href={role === "student" ? "/register-student" : "/register-faculty"} className="text-blue-500 hover:underline">
